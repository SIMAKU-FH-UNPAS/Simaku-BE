...
class TransaksiGajiController extends Controller
{
    ...
    private function _validate($request)
    {
        $validator = $request->validate([
            ...
            'tunjangan_struktural' => 'required|numeric',
            'tunjangan_khusus_istimewa' => 'required|numeric',
            'tunjangan_presensi_kerja' => 'required|numeric',
            'tunjangan_tambahan' => 'required|numeric',
            'tunjangan_suami_istri' => 'required|numeric',
            'tunjangan_anak' => 'required|numeric',
            'uang_lembur_hk' => 'required|numeric',
            'uang_lembur_hl' => 'required|numeric',
            'transport_kehadiran' => 'required|numeric',
            'honor_universitas' => 'required|numeric',
            // gaji fakultas
            'gaji_fakultas' => 'required|array',
            'gaji_fakultas.*' => 'numeric',
            // potongan
            'potongan' => 'required|array',
            'potongan.*' => 'numeric',
            // pajak
            'pensiun' => 'nullable|numeric',
            'bruto_pajak' => 'nullable|numeric',
            'bruto_murni' => 'nullable|numeric',
            'biaya_jabatan' => 'nullable|numeric',
            'aksa_mandiri' => 'nullable|numeric',
            'dplk_pensiun' => 'nullable|numeric',
            'jumlah_potongan_kena_pajak' => 'nullable|numeric',
            'jumlah_set_potongan_kena_pajak' => 'nullable|numeric',
            'ptkp' => 'nullable|numeric',
            'pkp' => 'nullable|numeric',
            'pajak_pph21' => 'nullable|numeric',
            'jumlah_set_pajak' => 'nullable|numeric',
            'potongan_tak_kena_pajak' => 'nullable|numeric',
            'pendapatan_bersih' => 'nullable|numeric',
            // master transaksi
            'pegawais_id' => 'required|numeric|exists:pegawais,id,deleted_at,NULL',
            'pegawais_bank_id' => [
                'required',
                'numeric',
    ...
    private function _validateUpdate($request)
    {
        $validator = $request->validate([
            ...
            'honor_universitas' => 'required|numeric',
            'gaji_fakultas' => 'required|array',
            // Validate each key in "gaji_fakultas" to be numeric
            'gaji_fakultas.*' => 'numeric',
            'potongan' => 'required|array',
            // Validate each key in "gaji_fakultas" to be numeric
            'potongan.*' => 'numeric',
            'pensiun' => 'required|numeric',
            'bruto_pajak' => 'required|numeric',
            'bruto_murni' => 'required|numeric',
            'biaya_jabatan' => 'required|numeric',
            'aksa_mandiri' => 'required|numeric',
            'dplk_pensiun' => 'required|numeric',
            'jumlah_potongan_kena_pajak' => 'required|numeric',
            'jumlah_set_potongan_kena_pajak' => 'required|numeric',
            'ptkp' => 'required|numeric',
            'pkp' => 'required|numeric',
            'pajak_pph21' => 'required|numeric',
            'jumlah_set_pajak' => 'required|numeric',
            'potongan_tak_kena_pajak' => 'required|numeric',
            'pendapatan_bersih' => 'required|numeric',
            'pegawais_bank_id' => [
                'required',
                'numeric',
                Rule::exists('pegawai_banks', 'id')
