...
use App\Http\Requests\dosentetap\CreatePotonganTambahanRequest;
use App\Http\Requests\dosentetap\UpdatePotonganTambahanRequest;
...
class PotonganTambahanController extends Controller
{
    ...
    if ($dostap_potongan_id) {
        $potongantambahan->where('dostap_potongan_id', $dostap_potongan_id);
    }
